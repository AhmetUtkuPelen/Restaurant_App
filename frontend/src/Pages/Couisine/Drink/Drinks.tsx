            ...
            <>
              ...
              >
                {paginatedDrinks.map((drink) => {
                  const drinkData = drink as typeof drink & {
                    image_url?: string;
                    image?: string;
                  ...
                  const hasDiscount =
                    (drink as typeof drink & { discount_percentage?: string })
                      .discount_percentage &&
                    parseFloat(
                      (drink as typeof drink & { discount_percentage?: string })
                        .discount_percentage || "0"
                    ) > 0;
                  const price = parseFloat(String(drink.price || "0"));
                  const finalPrice = parseFloat(
                    drinkData.final_price || String(drink.price || "0")
                  );
                      ...
                      >
                        <img
                          src={
                            drinkData.image_url ||
                            drinkData.image ||
                            "https://via.placeholder.com/300x200/1f2937/ffffff?text=Drink"
                          }
                          alt={drink.name}
                        ...
                        {((drink as typeof drink & { is_alcoholic?: boolean })
                          .is_alcoholic ||
                          drinkData.isAlcoholic) && (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-sm text-gray-400">
                            4.5 (
                            {(drink as typeof drink & { comments?: unknown[] })
                              .comments?.length ||
                              drinkData.reviews ||
                              0}{" "}
                            reviews)
                        ...
                        <Button
                          ...
                          className={`w-full transition-colors cursor-pointer ${isFavourite(drink.id)
